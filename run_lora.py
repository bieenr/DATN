...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--lora",
        type=str,
        default="/mnt/data/bientd/Marigold/output/train_lora_pretrain_skyscene_prompt_ver1/checkpoint/iter_000500/lora",
        help="Checkpoint path or hub name.",
    )
    ...
    rgb_filename_list = glob(input_rgb_dir+ "/**/*", recursive=True) # with image skyscene
    rgb_filename_list = [
    ...
    with torch.no_grad():
        ...
        for rgb_path in tqdm(rgb_filename_list, desc="Estimating depth", leave=True):
            # Read input image
            if rgb_path in [
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town01/007751_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town02/008450_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town03/512477_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town04/009156_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town05/009855_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town06/005175_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town07/003777_clrnoon.png', 
                '/mnt/data/Skyscene/Images/H_35_P45/ClearNoon/Town10HD/004476_clrnoon.png', 
                ]:
                continue

...
if "__main__" == __name__:
    ...
    for data in tqdm(dataloader, desc="Evaluating"):
        ...
        # #### VỚI ẢNH NDDEPTH
        # pred_path = os.path.join(prediction_dir, rgb_basename)
        
        #### VỚI ẢNH UNIDEPTH
        pred_path = os.path.join(prediction_dir, rgb_basename)
        pred_path = pred_path.replace(".png", "_pred_v1.png")
        try:
            depth_pred = Image.open(pred_path).convert('L')
            depth_pred = np.asarray(depth_pred)/255
